...
### Unlabeled Corpora
- Unlabeled domain-related corpora (domain-level, entity-level, task-level and integrated) for the five target domains can be downloaded [here](https://drive.google.com/drive/folders/1xDAaTwruESNmleuIsln7IaNleNsYlHGn?usp=sharing).
...
Politics domain. Span-level pre-training using integrated corpus.
```console
...
```
This code is modified based on run_language_modeling.py from [huggingface transformers](https://github.com/huggingface/transformers/tree/v3.1.0) (3.0.2).
